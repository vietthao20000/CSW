class MirrowDoubleStripeController{
  constructor(position) {

    this.partLeft = new StripeController({x : position.x - CSW.configs.GAME_WIDTH/4.5, y : position.y});
    this.partRight = new StripeMirrowController({x : position.x + CSW.configs.GAME_WIDTH/4.5 , y : position.y});
